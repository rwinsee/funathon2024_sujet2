...
output$accueil_content <- renderUI({
  tagList(
    div(
      ...
      br(),
      br(),
      p("Bienvenue sur le tableau de bord interactif du trafic aérien français."),
      p("Ce tableau de bord vous permet de visualiser et d'analyser des indicateurs nationaux,les données de fréquentation, de compagnies aériennes, de liaisons aériennes, de zones géographiques, de fret aérien."),
